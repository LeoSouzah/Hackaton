...
<p class="alert alert-warning">
	Existem <?=$produtos?> carro(s) diferente(s) no carrinho:
</p>
...
<a style=" margin-right: 15px;" href="index.php?pagina=limpar" class="btn btn-danger btn-lg float-right">
	Limpar Carrinho
</a>
<a style=" margin-right: 15px;" href="index.php?pagina=finalizar" class="btn btn-primary btn-lg float-right">
	Finalizar Pedido
</a>
