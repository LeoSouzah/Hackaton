...
<div class="row">
	<?php
		...
		while ( $dados = mysqli_fetch_array( $result ) ) {
			...
			"
			<div class='col-12 col-md-3 text-center' style='padding-left: 40px;'>
			<div class='card text-white bg-dark mb-3' style='width: 16rem; justify-content: center;  align-items: center;'>
