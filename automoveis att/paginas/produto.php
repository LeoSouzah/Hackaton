...
<div style="padding-left: 12px;" class="row" style="padding-right: 15px;">
	...
	<div class="col-12 col-md-8">
		...
		<form name="formProduto" method="post" action="index.php?pagina=adicionar">
			...
			<div style="width: 350px; margin-left: 300px; "class="input-group">
		...
		<?php 
		echo" 
				<div class='card text-white bg-dark mb-3' style='width: 14rem; margin-left:360px; font-family: Comic Sans, Comic Sans MS;'>
