...
<div class="row">
	<?php
		...
		while ( $dados = mysqli_fetch_array( $result ) ) {
			...
			"
			<div class='col-12 col-md-2 text-center' style='padding-left: 20px; '>
			<div class='card text-white bg-dark mb-3' style='width: 180px; justify-content: center;  align-items: center;'>
