...
<div class="row">
	<?php
		...
		while ( $dados = mysqli_fetch_array( $result ) ) {
			...
			<div class='card bg-light mb-3' style='width: 16rem; justify-content: center;  align-items: center;'>
            ...
            <a href='index.php?pagina=produto&id={$id}'' class='btn btn-primary'>Ver mais</a>
           </div>
          </div>
          </div>
