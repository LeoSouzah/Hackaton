...
<br>
<h1 style="font-family: Comic Sans, Comic Sans MS; text-align: center;">Carros seminovos:</h1>
<br>
<div class="row">
	<?php
		//selecionar 6 produtos - rand -> sorteio - limit limitar o nr de resultado
		$sql = "select * from veiculo where tipo=2";
		//executar o sql
		...
		while ( $dados = mysqli_fetch_array( $result ) ) {
			...
			"
			<div class='col-12 col-md-3 text-center' style='padding-left: 60px;'>
			<div class='card text-white bg-secondary mb-3' style='width: 16rem; justify-content: center;  align-items: center;'>
            ...
            <a href='index.php?pagina=produto&id={$id}'' class='btn btn-danger'>Ver mais</a>
           </div>
          </div>
          </div>
